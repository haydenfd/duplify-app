...
import { RadioGroup, Radio, cn, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure } from "@nextui-org/react";
      ...
      >
        ...
        <div className='my-6 flex flex-col items-center text-black relative'>
          <div className='w-3/5 relative'>
            ...
            />
            {!isValidPlaylistName && (
              <p className='text-[16px] text-red-500 absolute mt-2 font-bold'>Please enter a name</p>
            )}
          </div>
          <input
            type='text'
          ...
          >
            <Radio
              value="public"
              color="success"
              classNames={{ label: cn("text-white mr-20 text-center font-medium"), control: cn("p-4 bg-primaryGreen border-none outline-none") }}
            >
              Public
            </Radio>
            <Radio
